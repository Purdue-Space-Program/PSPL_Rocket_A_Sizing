...
variable_inputs = {
    ...
    "CHAMBER_PRESSURE":           np.linspace(80, 350, step_size) * c.PSI2PA, # [pa] pressure in the chamber during combustion
    

    "CONTRACTION_RATIO":          np.linspace(3, 6, step_size), # [dimensionless] area ratio of chamber to throat (3 to 6 recommended by textbook)
    "FUEL_TANK_LENGTH":   np.linspace(6 * c.IN2M, 4 * c.FT2M, step_size), # [meters] speedy metals pipe lengths: https://www.speedymetals.com/pc-4648-8371-6-od-x-0125-wall-tube-6061-t6-aluminum.aspx
