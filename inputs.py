...
variable_inputs = {
    ...
    # "FUEL_TANK_LENGTH":   np.linspace(1 * c.IN2M, 4 * c.FT2M, step_size), # [meters] speedy metals pipe lengths: https://www.speedymetals.com/pc-4648-8371-6-od-x-0125-wall-tube-6061-t6-aluminum.aspx
...
constant_inputs = {
    "CHAMBER_PRESSURE":                         150 * c.PSI2PA, # [psi] pressure in the chamber during combustion
    # "OF_RATIO":                                 1.5, # [dimensionless] ratio of oxygen to fuel by mass

    "FUEL_TANK_LENGTH":                         4 * c.FT2M, # [meters] speedy metals pipe lengths: https://www.speedymetals.com/pc-4648-8371-6-od-x-0125-wall-tube-6061-t6-aluminum.aspx
