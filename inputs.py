...
step_size = 1 # number of values to use for each variable input
...
variable_inputs = {
    ...
    "OF_RATIO":                   np.linspace(1, 2.001, step_size), # [dimensionless] ratio of oxygen to fuel by mass

    "CHAMBER_PRESSURE":           np.linspace(100, 400, step_size) * c.PSI2PA, # [pa] pressure in the chamber during combustion
...
constant_inputs = {
    ...
    "FUEL_TANK_LENGTH":                           24 * c.IN2M, # [meters] possible speedy metals pipe lengths: https://www.speedymetals.com/pc-4648-8371-6-od-x-0125-wall-tube-6061-t6-aluminum.aspx
