...
variable_inputs = {
    ...
    "OF_RATIO":                   np.linspace(2.9, 3, step_size), # [dimensionless] ratio of oxygen to fuel by mass

    "CHAMBER_PRESSURE":           np.linspace(200, 205, step_size) * c.PSI2PA, # [pa] pressure in the chamber during combustion
...
constant_inputs = {
    ...
    "FUEL_TANK_LENGTH":                           72 * c.IN2M, # [meters] possible speedy metals pipe lengths: speedymetals.com/changethelinkbro
