...
step_size = 80 # number of values to use for each variable input
...
variable_inputs = {
    ...
    "CONTRACTION_RATIO":          np.linspace(2.5, 7, step_size), # [dimensionless] area ratio of chamber to throat (3 to 6 recommended by textbook)
...
constant_inputs = {
    "CHAMBER_PRESSURE":                         50 * c.PSI2PA, # [psi] pressure in the chamber during combustion
